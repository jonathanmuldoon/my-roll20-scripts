            ...
            switch(state.TurnMarker && state.TurnMarker.version) {
                ...
                default:
                    state.TurnMarker = {
                        ...
                        tokenURL: 'https://s3.amazonaws.com/files.d20.io/images/11920268/i0nMbVlxQLNMiO12gW9h3g/thumb.png?1440939062',
                        playAnimations: true,
                        rotation: true,
                        animationSpeed: 5,
                        scale: 1.7,
...
'</div>'
    ...
    handleAnnounceTurnChange = function(){
        ...
        if(state.TurnMarker.announceTurnChange ) {
            ...
            var pNameString="'s turn has ended.";
            if(previousToken && previousToken.get('showplayers_name')) {
                pNameString='<span style=\''+
                    ...
                    '</span>\'s turn has ended.';                
            }
            
            var cNameString="Current turn is ";
            ...
            sendChat(
                '', 
                "/direct "+
                "<div style='border: 3px solid #808080; background-color: #9398a0; color: white; padding: 1px 1px;'>"+
